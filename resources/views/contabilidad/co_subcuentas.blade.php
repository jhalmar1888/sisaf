...
@section('subtitulo')
    <h1 class="page-header">Catalogo Sub Cuentas</h1>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title"> Catalogo Sub Cuentas </h4>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                        @foreach($co_subcuentas as $subcuenta)
                        <tr>
