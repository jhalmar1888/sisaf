...
@section('subtitulo')
    <h1 class="page-header">Agregar Comprobante de Traspaso</h1>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    {{ Form::open(['route' => 'contabilidad.postAgregarComprobanteTraspaso', 'method'  => 'POST', 'class' => 'form-horizontal form-bordered']) }}
