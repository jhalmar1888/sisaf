    ...
    <div class="login login-with-news-feed">
        ...
        <div class="news-feed">
            <div class="news-image">
                <img src="img/emi.jpeg" data-id="login-cover-image" alt="" />
            </div>
            <div class="news-caption">
                <h4 class="caption-title"><i class="fa fa-diamond text-success"></i> Escuela Militar de Ingenieria</h4>
                <p>
                    SISAF
                </p>
            </div>
        ...
        <div class="right-content">
            ...
            <div class="login-header">
                <div class="brand">
                    {{--<span class="logo"></span>--}} Sistema de Administracion Financiera
                    <small>Escuela Militar de Ingenieria</small>
                </div>
                <div class="icon">
