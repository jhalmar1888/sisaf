...
@section('rutas')
    <ol class="breadcrumb pull-right">
        <li>Agregar Articulo a Comprobante de Salida</li>
        {{--<li>Page Options</li>--}}
...
@section('subtitulo')
    <h1 class="page-header">Agregar Articulo a Comprobante de Salida</h1>
@endsection
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body panel-form">
                    {{ Form::open(['route' => 'almacen.postAgregarArticuloCS', 'method'  => 'POST', 'class' => 'form-horizontal form-bordered']) }}
                    {{ Form::hidden('id_compsalida', $comprobante->id) }}
